...
export const defaultSounds: { [key in SoundName]: string } = {
  ...
  "zombie-run-zombie-moving": "/sounds/corgi/rabid_dawg.mp3",
  ...
  "zombie-run-zombie-boost": "/sounds/zombie_brains.mp3",
  ...
  "mystery-box-bomb-dropper-move": "/sounds/default/jaws_opening_notes.mp3",
